...
interface QnADao {
    ...
    @Query("SELECT question.question_text as question, answer.text_value as answer FROM question, answer WHERE question.question_id = answer.question_id AND answer.option_id = ''")
